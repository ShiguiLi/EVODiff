...
from samplers.evodiff import EVODiff_edm
...
def sample(
    ...
    if method == "heun":
        ...
        evodiff = EVODiff_edm(ns, algorithm_type="data_prediction", correcting_x0_fn=None)

        def evodiff_sampler(model_fn, z):
            with torch.no_grad():
                x = evodiff.sample(
                    model_fn,
                    z,
